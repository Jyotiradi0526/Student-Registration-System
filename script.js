    ...
    if (getData.length > 0) {
        for (var i = tab_start; i < tab_end; i++) {
            ...
            if (staff) {
                ...
                <td>
                    <button onclick="readInfo('${staff.picture}', '${staff.fName}', '${staff.lName}', '${staff.ageVal}', '${staff.emailVal}', '${staff.phoneVal}')"><i class="fa-regular fa-eye"></i></button>

                    <button onclick="editInfo('${i}', '${staff.picture}', '${staff.fName}', '${staff.lName}', '${staff.ageVal}', '${staff.emailVal}', '${staff.phoneVal}')"><i class="fa-regular fa-pen-to-square"></i></button>
...
function readInfo(pic, fname, lname, Age, Email, Phone) {
    imgInput.src = pic
    fName.value = fname
    lName.value = lname
    age.value = Age
...
function editInfo(id, pic, fname, lname, Age, Email, Phone) {
    isEdit = true
    editId = id
